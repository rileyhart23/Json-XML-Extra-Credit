...
// dotnet run --project /Users/rileyhart/ExtraCredit/JsonProgramApp
...
namespace ExtraCredit
{
    public class JsonProgram
    {
        ...
        {
            string jsonFilePath = @"/Users/rileyhart/GitHub/WebsiteDevPortfolio/Json-XML-Extra-Credit/JsonProgramApp/bookstore.json";
            Bookstore bookstore = LoadBooksFromJson(jsonFilePath);

            Console.WriteLine("\t\tJson Program\n");
